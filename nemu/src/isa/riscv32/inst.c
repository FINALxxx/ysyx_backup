...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, printf("%ux",(uint32_t)(BITS(src1,32,16)*BITS(src2,32,16) + BITS(src1,32,16)*BITS(src2,15,0) + BITS(src1,15,0)*BITS(src2,32,16)) >> 16));//可以得到有符号数乘积的高32bits

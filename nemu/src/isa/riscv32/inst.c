...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(rd) = SEXT((int64_t)src1 * (int64_t)src2, 64) >> 32);//可以得到有符号数乘积的高32bits
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", divu, R, R(rd) = (uint32_t)src1 / (uint32_t)src2);

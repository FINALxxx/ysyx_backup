...
VL_ATTR_COLD void Vcpu___024root__trace_init_sub__TOP__0(Vcpu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+287,"src1", false,-1, 31,0);
    tracep->declBus(c+288,"src2", false,-1, 31,0);
    tracep->declBus(c+84,"imm", false,-1, 31,0);
    tracep->declBus(c+342,"src_rd", false,-1, 31,0);
    tracep->declBus(c+181,"src_rd_ALU", false,-1, 31,0);
    tracep->declBus(c+182,"src_rd_PMEM", false,-1, 31,0);
    ...
    tracep->declBit(c+183,"LESS", false,-1);
    tracep->declBit(c+184,"IS_ZERO", false,-1);
    tracep->declBit(c+185,"op_PC_Asrc", false,-1);
    ...
    tracep->declBus(c+186,"a0", false,-1, 31,0);
    tracep->declBus(c+187,"b0", false,-1, 31,0);
    tracep->declBus(c+188,"a1", false,-1, 31,0);
    tracep->declBus(c+189,"b1", false,-1, 31,0);
    ...
    tracep->declBus(c+181,"result", false,-1, 31,0);
    tracep->declBit(c+183,"LESS", false,-1);
    tracep->declBit(c+184,"IS_ZERO", false,-1);
    tracep->declBus(c+190,"ADDER_result", false,-1, 31,0);
    tracep->declBus(c+191,"SHIFT_result", false,-1, 31,0);
    tracep->declBus(c+192,"AND_result", false,-1, 31,0);
    tracep->declBus(c+193,"OR_result", false,-1, 31,0);
    tracep->declBus(c+194,"XOR_result", false,-1, 31,0);
    tracep->pushNamePrefix("add1 ");
    tracep->declBit(c+96,"mode", false,-1);
    tracep->declBus(c+188,"a", false,-1, 31,0);
    tracep->declBus(c+189,"b", false,-1, 31,0);
    tracep->declBit(c+94,"S_U", false,-1);
    tracep->declBus(c+190,"result", false,-1, 31,0);
    tracep->declBit(c+183,"LESS", false,-1);
    tracep->declBit(c+184,"IS_ZERO", false,-1);
    tracep->declBit(c+195,"overflow", false,-1);
    tracep->declBit(c+196,"carry", false,-1);
    tracep->declBit(c+197,"LESS_u", false,-1);
    tracep->declBit(c+198,"LESS_s", false,-1);
    tracep->declBus(c+199,"add_cin", false,-1, 31,0);
    ...
    tracep->declArray(c+200,"lut", false,-1, 279,0);
    ...
    for (int i = 0; i < 8; ++i) {
        tracep->declQuad(c+209+i*2,"pair_list", true,(i+0), 34,0);
    }
    for (int i = 0; i < 8; ++i) {
    ...
    tracep->declBit(c+93,"L_R", false,-1);
    tracep->declBit(c+95,"A_L", false,-1);
    tracep->declBus(c+188,"in", false,-1, 31,0);
    tracep->declBus(c+189,"soffset", false,-1, 31,0);
    ...
    tracep->declArray(c+236,"lut", false,-1, 101,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+381,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+387,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+382,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBit(c+289,"is_halt", false,-1);
    tracep->pushNamePrefix("mux1 ");
    tracep->declBus(c+381,"NR_KEY", false,-1, 31,0);
    ...
    tracep->declBus(c+406,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 2; ++i) {
        tracep->declQuad(c+290+i*2,"pair_list", true,(i+0), 32,0);
    }
    for (int i = 0; i < 2; ++i) {
    ...
    tracep->declBus(c+406,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 2; ++i) {
        tracep->declQuad(c+296+i*2,"pair_list", true,(i+0), 32,0);
    }
    for (int i = 0; i < 2; ++i) {
    ...
    tracep->declArray(c+255,"lut", false,-1, 101,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+381,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+387,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+382,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+388,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 3; ++i) {
        tracep->declQuad(c+259+i*2,"pair_list", true,(i+0), 33,0);
    }
    for (int i = 0; i < 3; ++i) {
    ...
    tracep->declBit(c+334,"clk", false,-1);
    tracep->declBit(c+335,"rst", false,-1);
    tracep->declBus(c+186,"a", false,-1, 31,0);
    ...
    tracep->declBit(c+270,"LESS", false,-1);
    tracep->declBit(c+377,"IS_ZERO", false,-1);
    tracep->declBit(c+378,"overflow", false,-1);
    tracep->declBit(c+270,"carry", false,-1);
    tracep->declBit(c+270,"LESS_u", false,-1);
    tracep->declBit(c+379,"LESS_s", false,-1);
    tracep->declBus(c+187,"add_cin", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+287,"rdata_a", false,-1, 31,0);
    tracep->declBus(c+288,"rdata_b", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
...
VL_ATTR_COLD void Vcpu___024root__trace_full_sub_0(Vcpu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+181,(vlSelf->cpu__DOT__src_rd_ALU),32);
    bufp->fullIData(oldp+182,(vlSelf->cpu__DOT__src_rd_PMEM),32);
    bufp->fullBit(oldp+183,(vlSelf->cpu__DOT__LESS));
    bufp->fullBit(oldp+184,((1U & (~ (IData)((0U != vlSelf->cpu__DOT__alu1__DOT__ADDER_result))))));
    bufp->fullBit(oldp+185,(vlSelf->cpu__DOT__op_PC_Asrc));
    bufp->fullIData(oldp+186,(vlSelf->cpu__DOT__a0),32);
    bufp->fullIData(oldp+187,(vlSelf->cpu__DOT__b0),32);
    bufp->fullIData(oldp+188,(vlSelf->cpu__DOT__a1),32);
    bufp->fullIData(oldp+189,(vlSelf->cpu__DOT__b1),32);
    bufp->fullIData(oldp+190,(vlSelf->cpu__DOT__alu1__DOT__ADDER_result),32);
    bufp->fullIData(oldp+191,(vlSelf->cpu__DOT__alu1__DOT__SHIFT_result),32);
    bufp->fullIData(oldp+192,((vlSelf->cpu__DOT__a1 
                               & vlSelf->cpu__DOT__b1)),32);
    bufp->fullIData(oldp+193,((vlSelf->cpu__DOT__a1 
                               | vlSelf->cpu__DOT__b1)),32);
    bufp->fullIData(oldp+194,((vlSelf->cpu__DOT__a1 
                               ^ vlSelf->cpu__DOT__b1)),32);
    bufp->fullBit(oldp+195,((((vlSelf->cpu__DOT__a1 
                               >> 0x1fU) == (vlSelf->cpu__DOT__alu1__DOT__add1__DOT__add_cin 
                                             >> 0x1fU)) 
                             & ((vlSelf->cpu__DOT__a1 
                                 >> 0x1fU) != (vlSelf->cpu__DOT__alu1__DOT__ADDER_result 
                                               >> 0x1fU)))));
    bufp->fullBit(oldp+196,((1U & (IData)((1ULL & (
                                                   ((QData)((IData)(vlSelf->cpu__DOT__a1)) 
                                                    + (QData)((IData)(vlSelf->cpu__DOT__alu1__DOT__add1__DOT__add_cin))) 
                                                   >> 0x20U))))));
    bufp->fullBit(oldp+197,((1U & ((0U != (IData)(vlSelf->cpu__DOT__op_ALU_sel)) 
                                   ^ (IData)((1ULL 
                                              & (((QData)((IData)(vlSelf->cpu__DOT__a1)) 
                                                  + (QData)((IData)(vlSelf->cpu__DOT__alu1__DOT__add1__DOT__add_cin))) 
                                                 >> 0x20U)))))));
    bufp->fullBit(oldp+198,((1U & ((((vlSelf->cpu__DOT__a1 
                                      >> 0x1fU) == 
                                   ...
                                   (vlSelf->cpu__DOT__alu1__DOT__ADDER_result 
                                    >> 0x1fU)))));
    bufp->fullIData(oldp+199,(vlSelf->cpu__DOT__alu1__DOT__add1__DOT__add_cin),32);
    ...
    __Vtemp_h0b480982__0[8U] = (vlSelf->cpu__DOT__alu1__DOT__ADDER_result 
                                >> 0xbU);
    bufp->fullWData(oldp+200,(__Vtemp_h0b480982__0),280);
    bufp->fullQData(oldp+209,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__pair_list[0]),35);
    bufp->fullQData(oldp+211,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__pair_list[1]),35);
    bufp->fullQData(oldp+213,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__pair_list[2]),35);
    bufp->fullQData(oldp+215,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__pair_list[3]),35);
    bufp->fullQData(oldp+217,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__pair_list[4]),35);
    bufp->fullQData(oldp+219,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__pair_list[5]),35);
    bufp->fullQData(oldp+221,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__pair_list[6]),35);
    bufp->fullQData(oldp+223,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__pair_list[7]),35);
    bufp->fullIData(oldp+225,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+226,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+227,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+228,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__data_list[3]),32);
    bufp->fullIData(oldp+229,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__data_list[4]),32);
    bufp->fullIData(oldp+230,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__data_list[5]),32);
    bufp->fullIData(oldp+231,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__data_list[6]),32);
    bufp->fullIData(oldp+232,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__data_list[7]),32);
    bufp->fullIData(oldp+233,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+234,(vlSelf->cpu__DOT__alu1__DOT__mux1__DOT__i0__DOT__hit));
    bufp->fullIData(oldp+235,(vlSelf->cpu__DOT__alu1__DOT__shift1__DOT____Vcellinp__mux1____pinNumber3),32);
    ...
    __Vtemp_hedab82a1__0[3U] = (0x30U | (vlSelf->cpu__DOT__alu1__DOT__shift1__DOT____Vcellinp__mux1____pinNumber3 
                                         >> 0x1cU));
    bufp->fullWData(oldp+236,(__Vtemp_hedab82a1__0),102);
    bufp->fullQData(oldp+240,(vlSelf->cpu__DOT__alu1__DOT__shift1__DOT__mux1__DOT__i0__DOT__pair_list[0]),34);
    bufp->fullQData(oldp+242,(vlSelf->cpu__DOT__alu1__DOT__shift1__DOT__mux1__DOT__i0__DOT__pair_list[1]),34);
    bufp->fullQData(oldp+244,(vlSelf->cpu__DOT__alu1__DOT__shift1__DOT__mux1__DOT__i0__DOT__pair_list[2]),34);
    bufp->fullIData(oldp+246,(vlSelf->cpu__DOT__alu1__DOT__shift1__DOT__mux1__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+247,(vlSelf->cpu__DOT__alu1__DOT__shift1__DOT__mux1__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+248,(vlSelf->cpu__DOT__alu1__DOT__shift1__DOT__mux1__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+249,(vlSelf->cpu__DOT__alu1__DOT__shift1__DOT__mux1__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+250,(vlSelf->cpu__DOT__alu1__DOT__shift1__DOT__mux1__DOT__i0__DOT__hit));
    bufp->fullIData(oldp+251,(vlSelf->cpu__DOT__mux1__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+252,(vlSelf->cpu__DOT__mux1__DOT__i0__DOT__hit));
    bufp->fullIData(oldp+253,(vlSelf->cpu__DOT__mux2__DOT__i0__DOT__lut_out),32);
    bufp->fullIData(oldp+254,(vlSelf->cpu__DOT__mux3__DOT__i0__DOT__lut_out),32);
    ...
    __Vtemp_h2a03d93b__0[3U] = (vlSelf->cpu__DOT__src2 
                                >> 0x1cU);
    bufp->fullWData(oldp+255,(__Vtemp_h2a03d93b__0),102);
    bufp->fullQData(oldp+259,(vlSelf->cpu__DOT__mux4__DOT__i0__DOT__pair_list[0]),34);
    bufp->fullQData(oldp+261,(vlSelf->cpu__DOT__mux4__DOT__i0__DOT__pair_list[1]),34);
    bufp->fullQData(oldp+263,(vlSelf->cpu__DOT__mux4__DOT__i0__DOT__pair_list[2]),34);
    bufp->fullIData(oldp+265,(vlSelf->cpu__DOT__mux4__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+266,(vlSelf->cpu__DOT__mux4__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+267,(vlSelf->cpu__DOT__mux4__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+268,(vlSelf->cpu__DOT__mux4__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+269,(vlSelf->cpu__DOT__mux4__DOT__i0__DOT__hit));
    bufp->fullBit(oldp+270,((1U & (IData)((1ULL & (
                                                   ((QData)((IData)(vlSelf->cpu__DOT__a0)) 
                                                    + (QData)((IData)(vlSelf->cpu__DOT__b0))) 
                                                   >> 0x20U))))));
    bufp->fullIData(oldp+271,(vlSelf->cpu__DOT__pmem1__DOT__rdata_tmp),32);
    ...
    __Vtemp_hecfd874a__0[3U] = (vlSelf->cpu__DOT__pmem1__DOT__rdata_tmp 
                                >> 0x1cU);
    bufp->fullWData(oldp+272,(__Vtemp_hecfd874a__0),102);
    bufp->fullQData(oldp+276,(vlSelf->cpu__DOT__pmem1__DOT__mux1__DOT__i0__DOT__pair_list[0]),34);
    bufp->fullQData(oldp+278,(vlSelf->cpu__DOT__pmem1__DOT__mux1__DOT__i0__DOT__pair_list[1]),34);
    bufp->fullQData(oldp+280,(vlSelf->cpu__DOT__pmem1__DOT__mux1__DOT__i0__DOT__pair_list[2]),34);
    bufp->fullIData(oldp+282,(vlSelf->cpu__DOT__pmem1__DOT__mux1__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+283,(vlSelf->cpu__DOT__pmem1__DOT__mux1__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+284,(vlSelf->cpu__DOT__pmem1__DOT__mux1__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+285,(vlSelf->cpu__DOT__pmem1__DOT__mux1__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+286,(vlSelf->cpu__DOT__pmem1__DOT__mux1__DOT__i0__DOT__hit));
    bufp->fullIData(oldp+287,(vlSelf->cpu__DOT__src1),32);
    bufp->fullIData(oldp+288,(vlSelf->cpu__DOT__src2),32);
    bufp->fullBit(oldp+289,(vlSelf->cpu__DOT__cu1__DOT__is_halt));
    bufp->fullQData(oldp+290,(vlSelf->cpu__DOT__mux2__DOT__i0__DOT__pair_list[0]),33);
    bufp->fullQData(oldp+292,(vlSelf->cpu__DOT__mux2__DOT__i0__DOT__pair_list[1]),33);
    bufp->fullIData(oldp+294,(vlSelf->cpu__DOT__mux2__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+295,(vlSelf->cpu__DOT__mux2__DOT__i0__DOT__data_list[1]),32);
    bufp->fullQData(oldp+296,(vlSelf->cpu__DOT__mux3__DOT__i0__DOT__pair_list[0]),33);
    bufp->fullQData(oldp+298,(vlSelf->cpu__DOT__mux3__DOT__i0__DOT__pair_list[1]),33);
    bufp->fullIData(oldp+300,(vlSelf->cpu__DOT__mux3__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+301,(vlSelf->cpu__DOT__mux3__DOT__i0__DOT__data_list[1]),32);

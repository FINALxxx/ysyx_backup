...
VL_INLINE_OPT void Vcpu___024root___nba_sequent__TOP__0(Vcpu___024root* vlSelf) {
    ...
    if ((0U == (0x1fU & (vlSelf->cpu__DOT__cmd >> 0xfU)))) {
        ...
        vlSelf->cpu__DOT__src1 = vlSelf->cpu__DOT__rf1__DOT__rf
            [(0x1fU & (vlSelf->cpu__DOT__cmd >> 0xfU))];

...
VL_ATTR_COLD void Vcpu___024root___eval_initial__TOP(Vcpu___024root* vlSelf) {
    ...
    vlSelf->cpu__DOT__mux5__DOT__i0__DOT__key_list[0U] = 2U;
    vlSelf->cpu__DOT__mux5__DOT__i0__DOT__key_list[1U] = 1U;
    vlSelf->cpu__DOT__mux5__DOT__i0__DOT__key_list[2U] = 0U;
...
VL_ATTR_COLD void Vcpu___024root___ctor_var_reset(Vcpu___024root* vlSelf) {
    ...
    vlSelf->cpu__DOT__src_rd_PMEM_origin = VL_RAND_RESET_I(32);
    ...
    for (int __Vi0 = 0; __Vi0 < 3; ++__Vi0) {
        vlSelf->cpu__DOT__mux5__DOT__i0__DOT__pair_list[__Vi0] = VL_RAND_RESET_Q(34);
    }
    for (int __Vi0 = 0; __Vi0 < 3; ++__Vi0) {
        vlSelf->cpu__DOT__mux5__DOT__i0__DOT__key_list[__Vi0] = VL_RAND_RESET_I(2);
    }
    for (int __Vi0 = 0; __Vi0 < 3; ++__Vi0) {
        vlSelf->cpu__DOT__mux5__DOT__i0__DOT__data_list[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->cpu__DOT__mux5__DOT__i0__DOT__lut_out = VL_RAND_RESET_I(32);
    vlSelf->cpu__DOT__mux5__DOT__i0__DOT__hit = VL_RAND_RESET_I(1);
